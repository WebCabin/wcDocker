...
Also note that the [wcDocker.EVENT.LOADED]{@link module:wcDocker.EVENT} event will only be triggered after all panels have finished their individual loading screens (if they are using it).