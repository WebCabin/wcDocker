...
Also note that the [wcDocker.EVENT.LOADED]{@link http://docker.api.webcabin.org/module-wcDocker.html#toc3} event will only be triggered after all panels have finished their individual loading screens (if they are using it).